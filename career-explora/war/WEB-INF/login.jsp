		...
		<div class="row xs-hidden sm-hidden index-header">
			<div class="col-md-5 col-md-offset-1">
				<span id="logo" class="mobile-logo">Career Explora</span> <a
					...
					class="btn btn-sm btn-info" v style="margin-bottom: 2%; margin-top: 1%;">Sign
					up</a>
			</div>
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<table style="width: 100%;">
									...
									<tr>
										<td></td>
										<td class="login-text"><input type="checkbox"
											style="margin: 2%;" /> Keep me logged in</td>
									</tr>
									<tr>
										<td></td>
										<td class="login-text" colspan="2"><input
											class="btn btn-info btn-sm" id="login" type="submit"
